...
#include "CZWeaponStructures.generated.h"

USTRUCT()
struct FZEquipmentData
{
	GENERATED_BODY()
...
UCLASS()
class NAKWON_API UCZWeaponStructures : public UObject
{
	GENERATED_BODY()
