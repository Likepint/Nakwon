...
private:
	...
	float Speed[(int32)ESpeed::MAX] = { 50, 150 };

public:
	FORCEINLINE bool CanMove() { return bCanMove; }

	FORCEINLINE float GetWalkSpeed() { return Speed[(int32)ESpeed::Walk]; }
	FORCEINLINE float GetRunSpeed() { return Speed[(int32)ESpeed::Run]; }
